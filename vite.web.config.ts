...
const dashboardOrigin=process.env.WEB_DASHBOARD_ORIGIN||"http://127.0.0.1:3100";
const directOrigin=process.env.WEB_DIRECT_ORIGIN||"http://127.0.0.1:3101";
if(dashboardOrigin===directOrigin) throw new Error("개인 키 화면은 별도 출처가 필요합니다.");
