...
function App(){
 ...
 const periodGain=(row:Snapshot,periodDays:number,table:string[])=>calculatePeriodGain(row,periodDays,table,scope==="guild");
 ...
 {scope==="guild"&&period&&<p className="muted">현재 길드원을 대상으로 날짜별 명단에 포함된 날의 획득량만 합산합니다. 소속 또는 경험치 기록이 없는 날짜는 일부 수집으로 표시합니다.</p>}
