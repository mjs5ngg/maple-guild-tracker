...
declare global {
 ...
 interface Window { AndroidAuth?:{startGoogleLogin:()=>void;sessionToken?:()=>string;clearSession?:()=>void;openPage?:(url:string)=>void;setSystemBars?:(dark:boolean,top:string,bottom:string)=>void};__androidBack?:()=>boolean }
}
