...
export default function SettingsDialog({open,onOpenChange,primary,setPrimary,signedIn,providers,onSave,onLogout,onDelete}:{open:boolean;onOpenChange:(value:boolean)=>void;primary:string;setPrimary:(value:string)=>void;signedIn:boolean;providers:Provider[];onSave:()=>void;onLogout:()=>void;onDelete:()=>void}){
