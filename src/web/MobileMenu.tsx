...
export default function MobileMenu<T extends string>({open,active,items,onNavigate,onClose,children,footer}:{open:boolean;active:T|"settings";items:MobileMenuItem<T>[];onNavigate:(key:T)=>void;onClose:()=>void;children:ReactNode;footer?:ReactNode}){
