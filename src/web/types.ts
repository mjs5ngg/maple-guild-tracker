...
export interface Snapshot {ocid:string;basic:Basic;observedAt:string;history:{date:string;basic:Basic}[];todayBaseline?:Basic;estimated?:boolean;isGuildMember?:boolean;guildMembership?:Record<string,boolean>|null}
declare global {
